...
// Import the actual thank you page component
...
export default function PreviewThankYouPage() {
  ...
  return (
    <div className="h-full flex flex-col -m-4 md:-m-6">
      ...
      {showDebugInfo && (
        <div className="bg-gradient-to-r from-purple-50 to-pink-50 border-l-4 border-purple-400 p-3 mx-4 md:mx-6 mt-4 md:mt-6 rounded-r-lg shadow-sm flex-shrink-0">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold text-purple-900">Thank You Page Preview</h3>
                <p className="text-sm text-purple-700">Exact post-registration experience</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <a
                ...
                className="inline-flex items-center gap-1 px-3 py-1 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors text-xs font-medium"
              >
      ...
      {!showDebugInfo && (
        <button
          ...
          className="fixed top-4 right-4 z-50 bg-purple-500 text-white p-2 rounded-full shadow-lg hover:bg-purple-600 transition-colors"
