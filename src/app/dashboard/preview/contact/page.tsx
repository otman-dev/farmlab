...
// Import the actual contact page component
...
export default function PreviewContactPage() {
  ...
  return (
    <div className="h-full flex flex-col -m-4 md:-m-6">
      ...
      {showDebugInfo && (
        <div className="bg-gradient-to-r from-teal-50 to-cyan-50 border-l-4 border-teal-400 p-3 mx-4 md:mx-6 mt-4 md:mt-6 rounded-r-lg shadow-sm flex-shrink-0">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold text-teal-900">Contact Page Preview</h3>
                <p className="text-sm text-teal-700">Exact public contact experience</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <a
                ...
                className="inline-flex items-center gap-1 px-3 py-1 bg-teal-600 text-white rounded-lg hover:bg-teal-700 transition-colors text-xs font-medium"
              >
              ...
              <button
                ...
                className="text-teal-600 hover:text-teal-800 font-bold text-lg leading-none"
      ...
      {!showDebugInfo && (
        <button
          ...
          className="fixed top-4 right-4 z-50 bg-teal-500 text-white p-2 rounded-full shadow-lg hover:bg-teal-600 transition-colors"
