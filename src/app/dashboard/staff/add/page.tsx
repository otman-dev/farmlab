  ...
  return (
    <div className="p-6 max-w-lg mx-auto">
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded shadow p-4 flex flex-col gap-4">
        ...
        <label className="flex flex-col">
          <span className="mb-1 font-medium">Contact (optional)</span>
          <input type="text" value={contact} onChange={e => setContact(e.target.value)} className="border rounded px-3 py-2" />
        </label>
